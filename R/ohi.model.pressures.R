##' Ocean Health Index: Pressures Model
##' 
##' The pressures model function computes a pressures score for each region
...
##' 
##' @aliases ohi.model.pressures ohi.pressure.category
...
##' region.
##' @seealso \code{\link{ohi.model.pressures.matrix}}
##' @keywords ohi
##' @examples
##' \dontrun{
