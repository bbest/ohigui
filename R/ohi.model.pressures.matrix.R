...
##' 
##' This function \code{ohi.model.pressures.matrix} will aggregate a
...
##' pressure] matrix \eqn{w(g,i,j)} used in \code{ohi.model.pressures}, such
##' that:
##' 
...
##' for \code{\link{ohi.model.pressures}}.
##' @seealso \code{\link{ohi.model.pressures}}
##' @keywords ohi
##' @export ohi.model.pressures.matrix
